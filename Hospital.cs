...
namespace QuickType
{
    ...
    public partial class Hospital
    {
        public static Hospital[] FromJson(string json) => JsonConvert.DeserializeObject<Hospital[]>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Hospital[] self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }
